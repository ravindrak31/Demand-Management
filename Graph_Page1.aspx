<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Graph_Page1.aspx.cs" Inherits="Graph_Page1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    &nbsp;&nbsp;&nbsp;
    <asp:Panel runat="server" Font-Names="Calibri Light" HorizontalAlign="Center">
   ...
   <br/>
<asp:Panel runat="server" HorizontalAlign="Center" Font-Names="Calibri Light">
