<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Demand_update.aspx.cs" Inherits="Demand_New" MasterPageFile="~/MasterPage.master" %>



<asp:Content runat="server" ID="content" ContentPlaceHolderId="ContentPlaceHolder1">
    <div style="margin-left: 240px">
            <asp:Panel ID="Panel1" runat="server" Height="477px" HorizontalAlign="Justify" ToolTip="Client Details Wizard" BackColor="#D4EBF3" Width="828px" style="margin-top: 0px" BorderColor="Black" BorderStyle="Outset">
                <fieldset class="formSection" >
                    ...
                    <asp:DropDownList ID="txt_Client_Name" Font-Names="Verdana" runat="server" Height="23px" Width="200px" AutoPostBack="true" TabIndex="1" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Font-Size="Small">
                    </asp:DropDownList>
                  ...
                  <asp:Label ID="Label2" runat="server" Font-Names="Calibri Light" height="19px" Text="Project Name : " width="219px"></asp:Label>
                    <asp:DropDownList ID="txt_Project_Name" runat="server" AutoPostBack="true" Font-Names="Verdana" Font-Size="Small" Height="21px" Width="536px" BorderStyle="Ridge" OnSelectedIndexChanged="txt_Project_Name_SelectedIndexChanged"></asp:DropDownList>
